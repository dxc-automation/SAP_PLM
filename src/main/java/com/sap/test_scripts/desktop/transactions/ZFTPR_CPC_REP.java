...
public class ZFTPR_CPC_REP extends GeneralTestConfig {

    private CommandField commandField = new CommandField();

    private String transactionWindowTitle = "Corporate PC Chargeback details report";
    private String transactionCode = "ZFTPR_CPC_REP";
